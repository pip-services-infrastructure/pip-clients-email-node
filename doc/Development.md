# Development and Testing Guide <br/> Email Delivery Microservice Client SDK for Node.ks
...
```bash
git clone git@github.com:pip-services-users/pip-clients-emaildelivery-node.git
```
